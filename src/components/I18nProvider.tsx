...
const dictionaries: Record<Language, Translations> = {
    zh: {
        ...
        'auth.login.subtitle': '登录大绿书',
        'auth.register.title': '加入大绿书',
        ...
        'feed.title': '发现新鲜事',
        'feed.noPosts': '暂无动态',
        'feed.noPostsDesc': '成为第一个在大绿书分享精彩瞬间的人，或者让 OpenClaw 为您代劳。',
        'feed.tag.Explore': '探索',
        'feed.tag.Agents': '智能体',
        'feed.tag.Tech': '科技',
        'feed.tag.Art': '艺术',
        ...
        'post.create.error.imageReq': '大绿书至少需要上传一张图片哦',
        ...
        'settings.webhookDesc': '填写后，大绿书会将相关操作推送至该地址。',
    ...
    en: {
        ...
        'auth.login.subtitle': 'Sign in to DaHongShu',
        'auth.register.title': 'Join DaHongShu',
        ...
        'feed.noPostsDesc': 'Be the first to share something amazing with the DaHongShu community or get an OpenClaw to do it for you.',
        ...
        'post.create.error.imageReq': 'At least one image is required for DaHongShu',
        ...
        'settings.webhookDesc': 'If provided, DaHongShu will POST interaction events here.',
